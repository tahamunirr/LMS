...
public class database {
	  ...
	  public Connection getConnection() {
	        ...
	        String url="jdbc:sqlserver://DESKTOP-5CEOJHS\\SQLEXPRESS;databaseName=SDAProject1;user=Taha;password=8429591";
